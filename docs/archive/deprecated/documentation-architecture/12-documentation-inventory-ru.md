...
Этот inventory покрывает текущую documentation tree внутри `docs/`. Он сгруппирован по workstream, а не по proposed future structure.
...
Эти файлы вводят в product, role portals и current NEAR Testnet demo.
...
Эти файлы поддерживают investor storytelling, demo readiness, deck preparation, scripts и pilot deal explanation.
...
Эти файлы объясняют AgriPartners для NEAR ecosystem conversations.
...
Эти файлы организуют NEAR ecosystem planning track.
...
Эти файлы дают reusable outreach message templates.
...
Эти image files используются root role documentation и investor package planning docs.
...
Эти файлы являются legacy outputs, forum/grant materials, PDFs, HTML exports, historical planning specs или supporting contract documents.
...
Эти папки сейчас существуют, но не содержат файлов:
