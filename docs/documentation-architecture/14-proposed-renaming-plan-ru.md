...
Этот документ предлагает future numbering convention. Он сам по себе не переименовывает файлы.
...
| `checklist.html` | `archive/checklist.html` (выполнено) |
| Исторические PDF из корня | перенесены в `archive/` с текущими именами |
