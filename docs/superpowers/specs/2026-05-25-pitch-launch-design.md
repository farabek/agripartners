...
- **2 подписанных договора Fidlot v5.9 с реальным фермером, каждый на $50,000 (итого $100,000)**
- Инвестиционная модель: $50k/сделка, 60/40 сплит, 20% performance fee
- Соло-фаундер, тракшн подтверждён реальными подписанными договорами
...
4. **What's Built** — MVP на testnet, demo видео/ссылка, **2 подписанных договора на $100k**
