...
Status: Historical analysis — superseded by the concise Alpha v1.2 operator briefs
...
PDF export readiness: Not a publication source. The current public briefs are generated by
`scripts/build_60_40_documents.py`.

Related architecture: [Platform Contract Architecture](PLATFORM_CONTRACT_ARCHITECTURE.md)

## Purpose

> Historical note: this audit records the earlier farmer-guide structure. The September 2026
> Alpha v1.2 publication replaced those guides with concise Uzbekistan Feedlot Operator briefs.
> Future legal drafting must use the mandatory Estonia-to-Uzbekistan boundary and separate written
> Operator Agreement; this file must not be treated as current legal or publication authority.
...
| Field | Audit finding |
| --- | --- |
| File name | `docs/60-40/source/en/Agri-Operator-Fidlot-v5.9-6040-EN.docx` |
| Related published PDF | `docs/60-40/pdf/en/Agri-Operator-Fidlot-v5.9-6040-EN.pdf` |
...
| Field | Audit finding |
| --- | --- |
| File name | `docs/60-40/source/en/Agri-Operator-VariantB-v2.1-6040-EN.docx` |
| Related published PDF | `docs/60-40/pdf/en/Agri-Operator-VariantB-v2.1-6040-EN.pdf` |
...
not be treated as the current legal title of the existing `Agri-Operator-Fidlot-v5.9-6040-EN.docx`
...
not be treated as the current legal title of the existing `Agri-Operator-VariantB-v2.1-6040-EN.docx`
file, which currently reads as a farmer guide and financial model. The name should be applied to a
future legally drafted version or to a formal agreement wrapper with the existing economics attached
as a schedule.
