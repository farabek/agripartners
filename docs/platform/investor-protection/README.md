# AgriPartners Investor Protection Framework
...
- the general framework and its terminology;
- the Fidlot-specific 44% calculation;
- the Hissar / VariantB-specific 53% calculation;
- draft contract terms and separate schedules for both models;
- scenarios that require further validation;
...
- [General Framework — English](FRAMEWORK_EN.md)
- [Общий механизм — Русский](FRAMEWORK_RU.md)
- [Fidlot Model — English](FIDLOT_MODEL_EN.md)
- [Модель Fidlot — Русский](FIDLOT_MODEL_RU.md)
- [Hissar / VariantB Model — English](VARIANTB_MODEL_EN.md)
- [Модель Hissar / VariantB — Русский](VARIANTB_MODEL_RU.md)
- [Draft Contract Terms — English](CONTRACT_TERMS_EN.md)
- [Проект договорных условий — Русский](CONTRACT_TERMS_RU.md)
